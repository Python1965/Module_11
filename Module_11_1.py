...
def single_disp(data):
    ...
    if P_value >= 0.05:
        ...
        return f"Мы отклоняем нулевую гипотезу то есть P value = {P_value}, H1 верна то есть минимум 2 группы данных различаются между собой в Генеральной совокупонсти"
